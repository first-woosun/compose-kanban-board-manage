...
- [] BoardUiTest 
  - [] 태스크 카드를 클릭하면 TaskEditDialog가 출력되어야 한다
  - [] TaskEditDialog에는 '삭제', '수정' 버튼이 출력되어야 한다
  - [] TODO 상태의 태스크를 클릭하면 다이얼로그에 담당자 없음이 표시된다
  - [] TODO 상태가 아닌 태스크를 클릭하면 다이얼로그에 담당자 없음이 표시되지 않는다
  - [] TODO 상태인 태스크를 삭제하면 태스크가 삭제되며 스낵바가 출력된다
  - [] IN_PROGRESS 상태인 태스크를 삭제하면 태스크가 삭제되며 스낵바가 출력된다
  - [] REVIEW 상태인 태스크를 삭제하면 삭제 불가능 스낵바가 표시된다
  - [] DONE 상태인 태스크를 삭제하면 삭제 불가능 스낵바가 표시된다
  - [] 담당자 없음 상태로 TODO 태스크를 생성할 수 있다
  - [] 담당자 없음 상태로 IN_PROGRESS 태스크를 생성할 수 없다
  - [] 담당자 없음 상태로 REVIEW 태스크를 생성할 수 없다
